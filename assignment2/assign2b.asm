...
// VERSION B - multiplicand value is 522133279 and multiplier is 200
// --------------------------------------------------------------------------------------------------------------------------------------------------------- //
...
main:	        stp     x29, x30, [sp, -16]!                                            // Store x29 frame pointer and x30 link register to the stack
                ...
                // Set variable values
                mov     multiplier, 200                                                 // Set multiplier value to 200
                mov     multiplicand, 522133279                                         // Set multiplicand value to 522133279
