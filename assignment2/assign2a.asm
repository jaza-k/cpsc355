...
// VERSION A - multiplicand value is -16843010 and multiplier is 70
// --------------------------------------------------------------------------------------------------------------------------------------------------------- //
...
main:	        stp     x29, x30, [sp, -16]!                                            // Store x29 frame pointer and x30 link register to the stack
                ...
                // Set variable values
                mov     multiplier, 70                                                  // Set multiplier value to 70
                mov     multiplicand, -16843010                                         // Set multiplicand value to -16843010 
...
loopCheck:      cmp     i, 32                                                           // Compares value of i to 32
                ...
                b.eq    printResult                                                     // If negative is true, branch to printResult
